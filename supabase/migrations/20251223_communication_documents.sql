...
-- Policy: Everyone can read active documents
...
CREATE INDEX communication_documents_category_idx ON public.communication_documents(category);
CREATE INDEX communication_documents_active_idx ON public.communication_documents(is_active);
CREATE INDEX communication_documents_display_order_idx ON public.communication_documents(display_order);
