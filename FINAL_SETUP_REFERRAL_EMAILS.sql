-- ==========================================
-- SETUP COMPLET : EMAILS PARRAINAGE + RLS POLICIES (SANS DOUBLONS)
-- ==========================================
-- Version corrigée pour osteo-upgrade.fr
-- À exécuter dans Supabase SQL Editor
-- ==========================================

-- ==========================================
-- 0. SUPPRESSION DES ANCIENNES ENTRÉES (ÉVITER LES DOUBLONS)
-- ==========================================

-- Supprimer les automation steps d'abord (dépendance)
...
-- Supprimer les templates de parrainage (sauf Premium Gold qu'on va UPDATE)
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://osteo-upgrade.fr/settings/referrals" style="display: inline-block; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: #1f2937; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 700; font-size: 16px; margin-right: 10px;">Espace Ambassadeur</a>
                <a href="https://osteo-upgrade.fr/dashboard" style="display: inline-block; background: white; border: 2px solid #f59e0b; color: #78350f; text-decoration: none; padding: 12px 30px; border-radius: 8px; font-weight: 700; font-size: 16px;">Accéder à la plateforme</a>
              </div>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://osteo-upgrade.fr/settings/referrals" style="display: inline-block; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">Voir ma cagnotte</a>
              </div>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://osteo-upgrade.fr/settings/referrals" style="display: inline-block; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">Voir ma cagnotte</a>
              </div>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://osteo-upgrade.fr/admin/referral-payouts" style="display: inline-block; background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">Gérer les demandes</a>
              </div>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://osteo-upgrade.fr/settings/referrals" style="display: inline-block; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">Voir mon espace ambassadeur</a>
              </div>
...
SELECT 'Templates créés/modifiés:' as info;
...
SELECT 'Automations créées:' as info;
