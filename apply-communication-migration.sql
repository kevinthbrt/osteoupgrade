-- ============================================
-- MIGRATION: Communication Documents Module
-- ============================================
-- Copiez et collez ce script complet dans le SQL Editor de Supabase
-- puis cliquez sur "Run" pour créer la table et les politiques RLS
...
-- Drop existing policies if they exist (pour éviter les erreurs si on réexécute)
...
-- Policy 1: Users can read active documents
CREATE POLICY "Anyone can read active communication documents"
  ON public.communication_documents
  FOR SELECT
  USING (is_active = true);

-- Policy 2: Admins can read ALL documents (active and inactive)
