...
- **La remise se voit sur la page** : un encart annonce le bonus avant l'inscription, là où il sert à la décider. Une fois le code obtenu, les blocs tarifs affichent le prix barré, le prix remisé, et un compte à rebours jusqu'à l'échéance du code ; la page d'inscription fait de même sur les trois abonnements. Le tout s'appuie sur un cookie posé à l'inscription, qui expire avec le code : passé la date, la page repasse d'elle-même au prix plein au lieu d'annoncer une remise qui n'existe plus. Ce cookie ne sert qu'à l'affichage, la remise étant relue sur le lead au paiement.
- **Remise activable funnel par funnel** (`promo_enabled`) : toute inscription sur n'importe quel funnel publié créait un code. Une page qui offre du contenu sans rien vendre en distribuait donc aussi, et n'aurait pas pu annoncer honnêtement une remise qu'elle ne maîtrisait pas. Désactivée par défaut, activée sur effet-placebo, réglable dans l'éditeur. (`supabase/migrations/20260924_funnel_promo_enabled.sql`)
- **Compte à rebours de remise** : à échéance, il annonce que la remise a expiré et que l'abonnement reste disponible, plutôt que « cette offre est terminée », qui aurait laissé croire qu'on ne pouvait plus s'abonner.
