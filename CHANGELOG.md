...
- **Couverture implicite des axes** : une phrase renseigne souvent un axe sans le nommer, et l'extraction produit désormais toutes les lignes correspondantes. « J'ai mal en plein milieu des lombaires » donne la localisation ET la latéralité, une douleur centrale, axiale ou « des deux côtés pareil » étant une réponse de latéralité et non une absence de réponse. Le praticien s'appuie sur ce qui reste non couvert pour savoir quoi demander : un axe réclamé à tort lui fait reposer une question déjà posée.
- **Dépistage des drapeaux rouges aligné sur la structuration** : la version abrégée de l'extraction en direct perdait une dizaine de signes par rapport à celle de `/api/osteoflow/ai` (réveils douloureux, altération de l'état général, paresthésies progressives, queue de cheval, suspicion de fracture, palpitations, céphalée en coup de tonnerre, vertiges, toxicomanie intraveineuse, bornes d'âge chiffrées). Les dix familles sont désormais reprises mot pour mot : un dépistage qui diffère selon l'écran n'est pas un dépistage. La consigne mentionne aussi explicitement le recoupement avec les lignes déjà relevées, l'extraction ne voyant qu'un passage à la fois.
