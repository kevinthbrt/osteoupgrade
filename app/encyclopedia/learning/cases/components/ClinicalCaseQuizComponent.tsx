...
interface ClinicalCaseQuizComponentProps {
  quiz: Quiz
  moduleId: string
  userId: string
  onQuizPassed: () => void
...
export default function ClinicalCaseQuizComponent({ quiz, moduleId, userId, onQuizPassed, onClose }: ClinicalCaseQuizComponentProps) {
  ...
  const calculateResults = async () => {
    ...
    // Save attempt to database (using clinical_case_quiz_attempts table)
    try {
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-xl font-semibold hover:from-amber-600 hover:to-amber-700 transition flex items-center justify-center gap-2"
              >
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex gap-3">
              {!passed && (
                <button
                  onClick={handleRetry}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-xl font-semibold hover:from-amber-600 hover:to-amber-700 transition flex items-center justify-center gap-2"
                >
                  <RotateCcw className="h-4 w-4" />
                  Réessayer
                </button>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-amber-500 to-orange-600 px-6 py-5 rounded-t-3xl">
          ...
          {quiz.description && (
            <p className="text-amber-100 text-sm">{quiz.description}</p>
          )}
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="h-2 bg-amber-400/30 rounded-full overflow-hidden">
              <div
        ...
        <div className="p-6 space-y-6">
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-6">
            <div className="flex items-start gap-3 mb-4">
              <div className="flex items-center justify-center w-8 h-8 rounded-full bg-amber-500 text-white font-bold text-sm shrink-0">
          ...
          {showExplanation && currentQuestion.explanation && (
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-amber-900 mb-1">Explication</h4>
                  <p className="text-amber-800 text-sm">{currentQuestion.explanation}</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="flex gap-2">
              {currentQuestion.explanation && currentQuestion.id && (
                <button
                  ...
                  className="px-4 py-2 rounded-lg font-medium text-amber-600 hover:bg-amber-50 transition"
                >
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-lg font-semibold hover:from-amber-600 hover:to-amber-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
