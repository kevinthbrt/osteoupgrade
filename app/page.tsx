          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/20 text-sky-400 px-4 py-2 rounded-full text-xs font-semibold mb-8 backdrop-blur-sm">
                ...
                Concu par des osteopathes, pour des osteopathes
              </div>
            ...
            <div className="rounded-3xl overflow-hidden border border-slate-200 shadow-xl">
              ...
              <div className="grid grid-cols-2 border-t border-slate-200">
                ...
                <div className="px-8 py-7 bg-amber-50 flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-lg font-bold text-slate-900">OsteoFlow inclus</div>
                    <div className="text-sm text-slate-600">Dossiers, consultations, comptabilite, facturation</div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                  <span className="font-semibold text-slate-700">OsteoFlow</span> est notre logiciel de gestion patients desktop, inclus avec l&apos;abonnement Premium. Dossiers patients, consultations, comptabilité, messagerie et statistiques — tout sur votre machine, sans abonnement supplémentaire.
                </p>

                <div className="grid grid-cols-2 gap-4 mb-8">
                  {[
                    { icon: Users, label: 'Dossiers patients', desc: 'Fiches completes avec historique de soins, anamnese et notes de consultation' },
                    { icon: Calendar, label: 'Consultations', desc: 'Suivi detaille de chaque seance, avec historique et recherche par patient' },
                    { icon: Wallet, label: 'Comptabilite & Factures', desc: 'Gestion financiere, exports, factures — tout centralisé sur votre machine' },
                    { icon: TrendingUp, label: 'Statistiques cabinet', desc: 'Visualisez l\'activite de votre cabinet et suivez votre progression' },
                  ].map((item) => {
                    const Icon = item.icon
                    return (
      ...
      <section className="py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              OsteoUpgrade est né d&apos;un constat simple : les ressources cliniques de qualite sont eparpillees, couteuses et difficiles a appliquer en cabinet. On a change ca.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Chaque test, chaque pathologie, chaque protocole est documente avec sa sensibilite, sa specificite et ses references EBP. Pas d\'opinion, que des preuves.',
              ...
              },
              {
                ...
                desc: 'Concu pour etre consulte en 10 secondes entre deux patients. Interface claire, recherche instantanee, contenu directement actionnable — pas un cours magistral.',
              ...
              },
              {
                ...
                desc: 'Nouvelles revues de litterature, nouveaux contenus, nouvelles fonctionnalites. La plateforme grandit avec votre pratique et integre les dernieres publications.',
      ...
      <section id="pricing" ref={pricing.ref} className="py-20 lg:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className={`text-center mb-16 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-4 tracking-tight">
              Tout inclus. Dès 29&euro;/mois.
            </h2>
            <p className="text-lg text-slate-500 max-w-xl mx-auto">
              OsteoUpgrade + OsteoFlow pour 29&euro;/mois — ou 240&euro;/an (20&euro;/mois). Moins cher qu&apos;un seul abonnement a une revue scientifique.
            </p>
          </div>
              ...
              <div className="relative p-8">
                ...
                <ul className="space-y-3 mb-8">
                  {[
                    ...
                    'OsteoFlow inclus — logiciel de cabinet desktop',
